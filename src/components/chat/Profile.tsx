                ...
                {isEditing ? (
                  ...
                  <>
                    <div className="flex items-center justify-between p-4">
                      ...
                      <span className="text-sm text-slate-400">{user?.email || 'No email'}</span>
                    </div>
                    <div className="flex items-center justify-center gap-3">
                      <p className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">
                        {settings.userName}
                      </p>
                      <button
                    ...
                    <p className="text-[10px] font-mono text-muted-foreground mt-1 uppercase tracking-wider opacity-50">UID: {user?.uid?.slice(0, 12)}...</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-card border rounded-2xl p-4 flex items-center gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-medium truncate">{user?.uid?.slice(0, 12)}</p>
              </div>
            </div>
